    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item"><a href="http://localhost/Assignment2/Home" class="nav-link">Home</a></li>
                <!-- <li class="nav-item"><a href="" class="nav-link">Menu</a></li>
                <li class="nav-item"><a href="" class="nav-link">Services</a></li>
                <li class="nav-item"><a href="" class="nav-link">Blog</a></li> -->
                <li class="nav-item active"><a href="http://localhost/Assignment2/About" class="nav-link">About</a></li>
                ...
                <li class="nav-item"><a href="http://localhost/Assignment2/Login" class="nav-link">Log In</a></li>
            </ul>
        </div>
    </div>
</nav>
            ...
            <div class="row slider-text justify-content-center align-items-center">
                ...
                <div class="col-md-7 col-sm-12 text-center ftco-animate">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a
                                href="http://localhost/Assignment2/Home">Home</a></span> <span>About</span>
                    </p>
                </div>
